...
public class Keys {
    ...
    public static final ForeignKey<OperationRecord, NarkoseStRecord> FK_OPERATION_NARKOSE_ST1 = Internal.createForeignKey(Operation.OPERATION, DSL.name("fk_operation_narkose_st1"), new TableField[] { Operation.OPERATION.NARKOSE_ST }, Keys.KEY_NARKOSE_ST_NARKOSE, new TableField[] { NarkoseSt.NARKOSE_ST.NARKOSE }, true);

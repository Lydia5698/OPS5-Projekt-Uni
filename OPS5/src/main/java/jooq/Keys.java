...
public class Keys {
    ...
    public static final ForeignKey<DiagnoseRecord, Icd10CodeStRecord> FK_DIAGNOSE_ICD10_CODE_ST = Internal.createForeignKey(Diagnose.DIAGNOSE, DSL.name("fk_diagnose_icd10_code_st"), new TableField[] { Diagnose.DIAGNOSE.ICD10_CODE }, Keys.KEY_ICD10_CODE_ST_PRIMARY, new TableField[] { Icd10CodeSt.ICD10_CODE_ST.ICD10_CODE }, true);

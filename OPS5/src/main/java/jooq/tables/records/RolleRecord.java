...
public class RolleRecord extends UpdatableRecordImpl<RolleRecord> implements Record8<Integer, String, Integer, LocalDateTime, LocalDateTime, String, String, Boolean> {
    ...
    @Override
    public Row8<Integer, String, Integer, LocalDateTime, LocalDateTime, String, String, Boolean> valuesRow() {
    ...
    @Override
    public RolleRecord value8(Boolean value) {
        setStorniert(value);
        return this;
    }

    @Override
    public RolleRecord values(Integer value1, String value2, Integer value3, LocalDateTime value4, LocalDateTime value5, String value6, String value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RolleRecord(Integer opId, String bearbeiter, Integer rolleSt, LocalDateTime bearbeiterZeit, LocalDateTime erstellZeit, String ersteller, String medPersonalPersId, Boolean storniert) {
        super(Rolle.ROLLE);

...
public class OperationRecord extends UpdatableRecordImpl<OperationRecord> implements Record16<Integer, LocalDateTime, LocalDateTime, Integer, Integer, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime, Boolean, Integer, Integer, Integer, Integer, String, String> {
    ...
    @Override
    public Row16<Integer, LocalDateTime, LocalDateTime, Integer, Integer, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime, Boolean, Integer, Integer, Integer, Integer, String, String> valuesRow() {
